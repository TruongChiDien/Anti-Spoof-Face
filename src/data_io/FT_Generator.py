...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default="datasets/rgb_image/org_1_80x60", help="path to dataset")
    parser.add_argument("--ft_path", type=str, default="datasets/rgb_image/ft_org_1_80x60", help="path to save trasformed images")
